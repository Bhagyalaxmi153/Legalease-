...
def lsp_my_bookings():
    ...
    #print("Raw bookings:", bookings)  # Debugging line

    # Get filters from the request
    time_filter = request.args.get('time_filter', 'all')
    slot_status = request.args.get('slot_status', 'all')
    ...
    for booking in bookings:
        #print("Processing booking:", booking)  # Debugging line
        ...
        if slot_status != 'All':
            if slot_status == 'Available' and booking.get('slot_status') != 'Available':
                continue
            if slot_status == 'Booked' and booking.get('slot_status') != 'Booked':
                continue
